 ...
 *
 */
public class RadioGroupV2 extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public RadioGroupV2(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public RadioGroupV2(Context context, AttributeSet attrs) {
        super(context, attrs);
        	...
        	((RadioButton) child).setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					if(mOnCheckedChangeListener != null){
						mOnCheckedChangeListener.onCheckedChanged(RadioGroupV2.this, child.getId());
					}
					return true;
				}
			});
        		...
        		if (view instanceof RadioButton) {
                	...
                	((RadioButton) button).setOnTouchListener(new OnTouchListener() {
        				...
        				public boolean onTouch(View v, MotionEvent event) {
        					...
        					if(mOnCheckedChangeListener != null){
        						mOnCheckedChangeListener.onCheckedChanged(RadioGroupV2.this, button.getId());
        					}
        					return true;
        				}
        			});
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RadioGroupV2.LayoutParams(getContext(), attrs);
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         *
         * @param radioGroupV2 the group in which the checked radio button has changed
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RadioGroupV2.this && child instanceof RadioButton) {
                int id = child.getId();
